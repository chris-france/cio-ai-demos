...
WORKBOOK_SECTIONS = {
    ...
    # ---- Course 3: AI-Powered IT Service Management (Lectures 14-21) ----
    14: {
        "title": "Help Desk Performance Baseline",
        "lecture_title": "The Help Desk is Broken",
        "sections": [
            {
                "key": "helpdesk_tickets",
                "title": "Support Ticket History — Last 90 Days",
                "type": "table",
                "columns": [
                    {"name": "ticket_id", "label": "Ticket ID", "type": "text"},
                    {"name": "subject", "label": "Subject", "type": "text"},
                    {"name": "category", "label": "Category", "type": "select",
                     "options": ["Hardware", "Software", "Network", "Access", "Email", "Other"]},
                    {"name": "priority", "label": "Priority", "type": "select",
                     "options": ["Critical", "High", "Medium", "Low"]},
                    {"name": "status", "label": "Status", "type": "select",
                     "options": ["Open", "In Progress", "Resolved", "Escalated", "Closed"]},
                    {"name": "channel", "label": "Channel", "type": "select",
                     "options": ["Slack", "Teams", "Email", "Portal", "Phone"]},
                    {"name": "submitter", "label": "Submitter", "type": "text"},
                    {"name": "department", "label": "Department", "type": "text"},
                    {"name": "location", "label": "Location", "type": "text"},
                    {"name": "resolution_minutes", "label": "Resolution (min)", "type": "number"},
                    {"name": "sla_breached", "label": "SLA Breached?", "type": "select",
                     "options": ["No", "Yes"]},
                ],
                "initial_rows": 25,
                "default_data": [
                    {"ticket_id": "TKT-001", "subject": "Laptop won't connect to projector in Conference Room B", "category": "Hardware", "priority": "High", "status": "Resolved", "channel": "Slack", "submitter": "Sarah Chen", "department": "Design", "location": "Charlotte", "resolution_minutes": 4, "sla_breached": "No"},
                    {"ticket_id": "TKT-002", "subject": "Second monitor flickering intermittently", "category": "Hardware", "priority": "Medium", "status": "Resolved", "channel": "Portal", "submitter": "James Park", "department": "Civil", "location": "Raleigh", "resolution_minutes": 8, "sla_breached": "No"},
                    {"ticket_id": "TKT-003", "subject": "Keyboard not working after coffee spill", "category": "Hardware", "priority": "High", "status": "Resolved", "channel": "Teams", "submitter": "Mike Torres", "department": "Construction Mgmt", "location": "Charlotte", "resolution_minutes": 45, "sla_breached": "No"},
                    {"ticket_id": "TKT-004", "subject": "Laptop running extremely slow, fan constantly on", "category": "Hardware", "priority": "Medium", "status": "Resolved", "channel": "Email", "submitter": "Lisa Wang", "department": "Design", "location": "Charlotte", "resolution_minutes": 12, "sla_breached": "No"},
                    {"ticket_id": "TKT-005", "subject": "Docking station not recognizing external drives", "category": "Hardware", "priority": "Low", "status": "Resolved", "channel": "Portal", "submitter": "Tom Bradley", "department": "Survey", "location": "Raleigh", "resolution_minutes": 15, "sla_breached": "No"},
                    {"ticket_id": "TKT-006", "subject": "Revit keeps crashing on large models (out of memory)", "category": "Software", "priority": "Critical", "status": "Resolved", "channel": "Slack", "submitter": "David Kim", "department": "Design", "location": "Charlotte", "resolution_minutes": 35, "sla_breached": "No"},
                    {"ticket_id": "TKT-007", "subject": "Can't install AutoCAD 2025.1 update (error 1603)", "category": "Software", "priority": "Medium", "status": "Resolved", "channel": "Email", "submitter": "Rachel Green", "department": "Civil", "location": "Raleigh", "resolution_minutes": 20, "sla_breached": "No"},
                    {"ticket_id": "TKT-008", "subject": "Excel macro stopped working after Office update", "category": "Software", "priority": "High", "status": "Resolved", "channel": "Teams", "submitter": "Patricia Adams", "department": "Finance", "location": "Charlotte", "resolution_minutes": 60, "sla_breached": "No"},
                    {"ticket_id": "TKT-009", "subject": "Bluebeam license server not responding (all Raleigh)", "category": "Software", "priority": "Critical", "status": "Resolved", "channel": "Phone", "submitter": "Kevin Rhodes", "department": "Construction Mgmt", "location": "Raleigh", "resolution_minutes": 15, "sla_breached": "No"},
                    {"ticket_id": "TKT-010", "subject": "VPN drops every 15 minutes working from home", "category": "Network", "priority": "High", "status": "Resolved", "channel": "Slack", "submitter": "Amy Foster", "department": "MEP", "location": "Charlotte", "resolution_minutes": 10, "sla_breached": "No"},
                    {"ticket_id": "TKT-011", "subject": "WiFi extremely slow on 3rd floor Charlotte (daily)", "category": "Network", "priority": "Medium", "status": "Open", "channel": "Portal", "submitter": "Steve Martinez", "department": "Structural", "location": "Charlotte", "resolution_minutes": 0, "sla_breached": "No"},
                    {"ticket_id": "TKT-012", "subject": "Can't access shared drive from Raleigh office", "category": "Network", "priority": "Critical", "status": "Resolved", "channel": "Phone", "submitter": "Nancy Ortiz", "department": "Design", "location": "Raleigh", "resolution_minutes": 25, "sla_breached": "No"},
                    {"ticket_id": "TKT-013", "subject": "Need ACC access to Terminal Expansion project", "category": "Access", "priority": "Medium", "status": "Resolved", "channel": "Email", "submitter": "Jennifer Liu", "department": "Design", "location": "Charlotte", "resolution_minutes": 120, "sla_breached": "No"},
                    {"ticket_id": "TKT-014", "subject": "Password reset - locked out of everything", "category": "Access", "priority": "High", "status": "Resolved", "channel": "Phone", "submitter": "Carlos Reyes", "department": "Survey", "location": "Raleigh", "resolution_minutes": 3, "sla_breached": "No"},
                    {"ticket_id": "TKT-015", "subject": "New hire Maria Santos - full onboarding needed Monday", "category": "Access", "priority": "High", "status": "In Progress", "channel": "Email", "submitter": "HR Team", "department": "HR", "location": "Charlotte", "resolution_minutes": 0, "sla_breached": "No"},
                    {"ticket_id": "TKT-016", "subject": "Not receiving emails from external clients", "category": "Email", "priority": "Critical", "status": "Resolved", "channel": "Slack", "submitter": "Robert Hayes", "department": "Construction Mgmt", "location": "Charlotte", "resolution_minutes": 20, "sla_breached": "No"},
                    {"ticket_id": "TKT-017", "subject": "Outlook keeps asking for password every 10 minutes", "category": "Email", "priority": "Medium", "status": "Resolved", "channel": "Teams", "submitter": "Diana Cross", "department": "Marketing", "location": "Charlotte", "resolution_minutes": 6, "sla_breached": "No"},
                    {"ticket_id": "TKT-018", "subject": "Projector in Conf Room B not working AGAIN", "category": "Hardware", "priority": "Medium", "status": "Resolved", "channel": "Slack", "submitter": "Alex Turner", "department": "Exec", "location": "Charlotte", "resolution_minutes": 3, "sla_breached": "No"},
                    {"ticket_id": "TKT-019", "subject": "VPN disconnect again - GlobalProtect (3rd time this week)", "category": "Network", "priority": "High", "status": "Resolved", "channel": "Slack", "submitter": "Amy Foster", "department": "MEP", "location": "Charlotte", "resolution_minutes": 25, "sla_breached": "No"},
                    {"ticket_id": "TKT-020", "subject": "3rd floor WiFi slow AGAIN at 10am", "category": "Network", "priority": "Medium", "status": "Open", "channel": "Portal", "submitter": "Steve Martinez", "department": "Structural", "location": "Charlotte", "resolution_minutes": 0, "sla_breached": "No"},
                    {"ticket_id": "TKT-021", "subject": "Need Zoom Pro license for client calls", "category": "Software", "priority": "Medium", "status": "Resolved", "channel": "Email", "submitter": "Brian Foster", "department": "Design", "location": "Raleigh", "resolution_minutes": 2, "sla_breached": "No"},
                    {"ticket_id": "TKT-022", "subject": "Printer on 2nd floor jammed", "category": "Hardware", "priority": "Low", "status": "Resolved", "channel": "Slack", "submitter": "Kelly Nguyen", "department": "HR", "location": "Charlotte", "resolution_minutes": 5, "sla_breached": "No"},
                    {"ticket_id": "TKT-023", "subject": "MFA not sending codes after phone change", "category": "Access", "priority": "High", "status": "Resolved", "channel": "Phone", "submitter": "Daniel Wright", "department": "Finance", "location": "Raleigh", "resolution_minutes": 8, "sla_breached": "No"},
                    {"ticket_id": "TKT-024", "subject": "Teams meeting recordings not saving", "category": "Software", "priority": "High", "status": "Resolved", "channel": "Teams", "submitter": "Amanda Peters", "department": "Construction Mgmt", "location": "Charlotte", "resolution_minutes": 5, "sla_breached": "No"},
                    {"ticket_id": "TKT-025", "subject": "Civil 3D surface not displaying correctly after LiDAR import", "category": "Software", "priority": "Medium", "status": "Resolved", "channel": "Portal", "submitter": "Chris Powell", "department": "Survey", "location": "Raleigh", "resolution_minutes": 90, "sla_breached": "No"},
                ],
            },
            {
                "key": "helpdesk_baseline",
                "title": "Current Help Desk Metrics",
                "fields": [
                    {"name": "total_staff", "label": "Total IT Support Staff", "type": "number"},
                    {"name": "avg_tickets_month", "label": "Average Tickets Per Month", "type": "number"},
                    {"name": "avg_resolution_hours", "label": "Average Resolution Time (hours)", "type": "number"},
                    {"name": "annual_support_cost", "label": "Annual IT Support Cost", "type": "text", "placeholder": "$"},
                    {"name": "satisfaction_score", "label": "Employee Satisfaction (1-10)", "type": "number", "min": 1, "max": 10},
                    {"name": "sla_compliance", "label": "SLA Compliance Rate (%)", "type": "number"},
                    {"name": "top_complaint", "label": "Top Employee Complaint About IT Support", "type": "textarea"},
                ],
                "default_data": {
                    "total_staff": 8,
                    "avg_tickets_month": 340,
                    "avg_resolution_hours": 6.5,
                    "annual_support_cost": "$960,000",
                    "satisfaction_score": 5,
                    "sla_compliance": 72,
                    "top_complaint": "Takes too long to get a response. Simple things like password resets shouldn't take 2 hours. Phone tree is frustrating - just let me talk to someone.",
                },
            },
        ],
    },
