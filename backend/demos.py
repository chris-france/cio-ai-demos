...
FOUNDATION_DEMOS = [
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "First, try to fetch my vendor invoice data from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/3/vendor_invoices\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: vendor-invoices.csv\n\n"
            "Use this data to "
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Try to fetch my SaaS inventory from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/7/saas_audit\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: saas-inventory.csv\n\n"
...
ADVANCED_DEMOS = [
    {
        ...
        "cc_prompt": (
            ...
            "mission statement).\n\n"
            "Try to fetch the IT portfolio data from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/8\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: sample-it-portfolio.csv\n\n"
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Try to fetch the SaaS evaluation data from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/10\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: saas-evaluation.csv\n\n"
            "The workbook has test data already loaded for Meridian Engineering — use that. "
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Try to fetch the team roster data from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/11\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: team-roster.csv\n\n"
            "The workbook has test data already loaded for Meridian Engineering — use that. "
            "Build a Skills "
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Try to fetch the AI tools inventory from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/12\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: ai-tools-inventory.csv\n\n"
            "The workbook has test data already loaded for Meridian Engineering — use that. "
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Try to fetch the org chart data from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/14\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: org-chart.csv\n\n"
            "The workbook has test data already loaded for Meridian Engineering — use that. "
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Try to fetch the vendor contract data from the course workbook API:\n"
            "curl -s http://localhost:18801/api/workbook/15\n"
            "If the API is not running or returns an error, fall back to the CSV file "
            "in this folder: vendor-contracts.csv\n\n"
            "The workbook has test data already loaded for Meridian Engineering — use that. "
            "Build a Vendor Risk "
...
SERVICE_MGMT_DEMOS = [
    {
        ...
        "steps": [
            "Open http://localhost:18802 → Workbook tab → expand Lecture 16 to review ticket data",
            "Open any terminal and type: claude",
            "Paste the prompt below",
        ...
        "cc_prompt": (
            ...
            "curl -s http://localhost:18801/api/workbook/16/helpdesk_tickets\n\n"
            "Also fetch my baseline metrics:\n"
            "curl -s http://localhost:18801/api/workbook/16/helpdesk_baseline\n\n"
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Fetch ticket data: curl -s http://localhost:18801/api/workbook/16/helpdesk_tickets\n\n"
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Fetch resolved tickets: curl -s http://localhost:18801/api/workbook/16/helpdesk_tickets\n\n"
    ...
    },
    {
        ...
        "cc_prompt": (
            ...
            "Fetch baseline data: curl -s http://localhost:18801/api/workbook/16/helpdesk_baseline\n\n"
